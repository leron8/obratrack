...
import { LayoutDashboard, Folder, DollarSign, Users, ClipboardList, Truck, Building2, FileText, Settings2, CalendarCheck, CreditCard, Wallet, Activity } from "lucide-react";
...
const navItems = [
  ...
  { href: "/accounts/movements", label: "Saldos", icon: Activity },
